...
Ospath = sorted(os.listdir(r"C:\Users\{}\Desktop\ImageToPDF".format(host)))
imageList = [(Image.open(r"C:\Users\{}\Desktop\ImageToPDF\{}".format(host, n))).convert('RGB') for n in Ospath]
